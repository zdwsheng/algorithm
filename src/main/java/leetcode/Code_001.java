 ...
 * 所以返回 [0, 1]
 */
public class Code_001 implements Common {
    private Code_001() {
    }

    private static final Code_001 CODE_001_INSTANCE = new Code_001();

    public static void main(String[] args) throws JsonProcessingException {
        int[] nums = new int[]{-1, -2, -3, -4, -5};
        int target = -8;
        int[] position = findByMap(nums, target);
        System.out.println(CODE_001_INSTANCE.toJsonString(position));
    }
